        ...
        <div className="py-3">
            <div className="mx-auto max-w-4xl flex justify-between items-center px-4">
              ...
              items-center justify-center border dark:bg-transparent dark:border-gray-300 dark:text-white ring-blue-500 focus:ring-2 focus:outline-none">
                    ...
                    {/*Socials media links*/}
                    <Socials name="gmail" href={"mailto:"+socials.gmail} fontAwesomeClassname="fa fa-envelope"/>
                    <Socials name="github" href={socials.github} fontAwesomeClassname="fab fa-github"/>
                    <Socials name="linkedin" href={socials.linkedIn} fontAwesomeClassname="fab fa-linkedin"/>
                </div>
            </div>
        </div>
    </div>
